...
#### Temporal Analysis of Order by Hour and Day

![Temporal Analysis](./sample_results/plots/01_temporal_analysis.png)

#### Economy Analysis

![Economy Analysis](./sample_results/plots/02_economic_analysis.png)

#### Simulation Diagnosis

![Simulation Diagnosis](./sample_results/plots/03_simulation_diagnostics.png)

#### Projected Revenue Per Optimized Store Location
